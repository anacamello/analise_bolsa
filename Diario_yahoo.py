                ...
                if(mediaVolume >= volume_min):
                    ...
                    while variacao <= variacao_max:
                        ...
                        if(ganho > 0.75): 
                            ...
                            tabela_relatorio_compra = pd.concat([tabela_relatorio_compra['Código': acao], tabela_relatorio_compra['Variação': variacao], tabela_relatorio_compra['Ganho': ganho], tabela_relatorio_compra['Média do Volume no Período': mediaVolume], tabela_relatorio_compra['Preço de Entrada': precoEntrada], tabela_relatorio_compra['Data Referência': ultima_data],                                                                 tabela_relatorio_compra['Qtd. Trades': qtdTrades], tabela_relatorio_compra['Qtd. Trades Positivos': qtdTradesPositivos], tabela_relatorio_compra['Qtd. Trades Negativos': qtdTradesNegativos], tabela_relatorio_compra['Média dos Trades Positivos': mediaTradesPositivos], tabela_relatorio_compra['Média dos Trades Negativos': mediaTradesNegativos], tabela_relatorio_compra['Maior Trade Positivo': maiorTradePositivo],tabela_relatorio_compra['Menor Trade Positivo': menorTradePositivo], tabela_relatorio_compra['Maior Trade Negativo': maiorTradeNegativo], tabela_relatorio_compra['Menor Trade Negativo': menorTradeNegativo], tabela_relatorio_compra['Resultado': resultado]], axis = 0)
