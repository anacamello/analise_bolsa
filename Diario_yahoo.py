                ...
                if(mediaVolume >= volume_min):
                    ...
                    while variacao <= variacao_max:
                        ...
                        if(ganho > 0.75): 
                            ...
                            tabela_relatorio_compra = pd.concat([tabela_relatorio_compra['Código': acao], tabela_relatorio_compra['Variação': variacao], tabela_relatorio_compra['Ganho': ganho], 
                                                                 ...
                                                                 tabela_relatorio_compra['Resultado': resultado]], axis = 1)
                ...
                if(mediaVolume >= volume_min):
                    ...
                    while variacao <= variacao_max:
                        ...
                        if(ganho > 0.75): 
                            ...
                            tabela_relatorio_venda = pd.concat([tabela_relatorio_venda['Código': acao], tabela_relatorio_venda['Variação': variacao], tabela_relatorio_venda['Ganho': ganho] , tabela_relatorio_venda['Média do Volume no Período': mediaVolume] , 
                                ...
                                tabela_relatorio_venda['Maior Trade Negativo': maiorTradeNegativo] , tabela_relatorio_venda['Menor Trade Negativo': menorTradeNegativo] , tabela_relatorio_venda['Resultado': resultado]], axis = 1)
